...
- [ ] 1. 为 `tests/feature` 目录新增属性测试文件
  - [ ] 1.1 创建 `tests/feature/API_BIND.property.spec.ts`
  ...
  - [ ] 1.2 创建 `tests/feature/API_TOKEN.property.spec.ts`
  ...
  - [ ] 1.3 创建 `tests/feature/API_TO_CONSTANT_VALUE.property.spec.ts`
  ...
  - [ ] 1.4 创建 `tests/feature/API_TO_DYNAMIC_VALUE.property.spec.ts`
  ...
  - [ ] 1.5 创建 `tests/feature/API_IS_BOUND.property.spec.ts`
  ...
  - [ ] 1.6 创建 `tests/feature/API_TRANSIENT.property.spec.ts`
...
- [ ] 2. 为 `tests/errors` 目录新增属性测试文件
  - [ ] 2.1 创建 `tests/errors/ERRORS.property.spec.ts`
...
- [ ] 3. 为 `tests/hooks` 目录新增属性测试文件
  - [ ] 3.1 创建 `tests/hooks/HOOKS.property.spec.ts`
...
- [ ] 4. 为 `tests/activation` 目录新增属性测试文件
  - [ ] 4.1 创建 `tests/activation/ACTIVATION.property.spec.ts`
...
- [ ] 5. 为 `tests/lazyinject` 目录新增属性测试文件
  - [ ] 5.1 创建 `tests/lazyinject/LAZY_INJECT.property.spec.ts`
...
- [ ] 6. 为 `tests/special` 目录新增属性测试文件
  - [ ] 6.1 创建 `tests/special/DI_HIERARCHY.property.spec.ts`
...
- [ ] 7. 为 `tests/coverage` 目录新增属性测试文件
  - [ ] 7.1 创建 `tests/coverage/COVERAGE.property.spec.ts`
...
- [ ] 8. 为 `tests/container` 目录新增属性测试文件
  - [ ] 8.1 创建 `tests/container/CONTAINER.property.spec.ts`
...
- [ ] 9. 为 `tests/decorate` 和 `tests/decorator` 目录新增属性测试文件
  - [ ] 9.1 创建 `tests/decorate/DECORATE.property.spec.ts`
  ...
  - [ ] 9.2 创建 `tests/decorator/DECORATOR.property.spec.ts`
...
- [ ] 11. 为 `tests/quality` 目录新增属性测试文件（第一批）
  - [ ] 11.1 创建 `tests/quality/binding-strategy.property.spec.ts`
  ...
  - [ ] 11.2 创建 `tests/quality/cachemap-type-safety.property.spec.ts`
  ...
  - [ ] 11.3 创建 `tests/quality/error-handling.property.spec.ts`
  ...
  - [ ] 11.4 创建 `tests/quality/token-improvement.property.spec.ts`
...
- [ ] 12. 为 `tests/quality` 目录新增属性测试文件（第二批）
  - [ ] 12.1 创建 `tests/quality/unbind-safety.property.spec.ts`
  ...
  - [ ] 12.2 创建 `tests/quality/container-get.property.spec.ts`
  ...
  - [ ] 12.3 创建 `tests/quality/child-lifecycle.property.spec.ts`
  ...
  - [ ] 12.4 创建 `tests/quality/regression.property.spec.ts`
