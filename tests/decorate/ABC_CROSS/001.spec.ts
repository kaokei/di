import { Optional, Inject, Container, LazyToken, decorate } from '@/index';
...
decorate([Inject(new LazyToken(() => B)), Optional()], A, 'b');
decorate([Inject(new LazyToken(() => C)), Optional()], A, 'c');
