...
describe('options -> AB_CONTAIN -> P -> 010: A parent injector B parent injector', () => {
...
describe('options -> AB_CONTAIN -> P -> 010: A child injector B child injector', () => {
  let parent: Container;
  let child: Container;
...
describe('options -> AB_CONTAIN -> P -> 010: A parent injector B child injector', () => {
  let parent: Container;
  let child: Container;
...
describe('options -> AB_CONTAIN -> P -> 010: A child injector B parent injector', () => {
  let parent: Container;
  let child: Container;
